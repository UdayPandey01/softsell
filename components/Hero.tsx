      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-lg">
              Recover up to 70% of your investment on software licenses you&apos;re
              no longer using. Our secure marketplace connects you directly with
              verified buyers.
            </p>
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex justify-between items-center p-3 bg-blue-700/30 backdrop-blur-sm rounded-lg"
                    >
            ...
            >
              <div className="max-w-md p-6">
                ...
                <p className="mt-3 text-left text-base text-blue-100">
                  Join over 2,500 companies who have recovered millions in
                  unused software investments.
                </p>
              </div>
              <div className="absolute -right-4 lg:-right-[20%] -bottom-6 flex space-x-4">
                {["Microsoft", "Adobe", "Salesforce"].map((company, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-center w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-xl"
                  >
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70">
            {["microsoft", "adobe", "ibm", "oracle", "google"].map(
              (company, index) => (
